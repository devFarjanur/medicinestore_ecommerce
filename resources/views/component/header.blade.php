...
<header class="primary-header primary-header--fixed gheader z-2 w-100">
    <div class="ghead-topbar header-top d-none d-lg-block">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xxl-4 col-xl-3">
                    <div class="topbar-info d-none d-xl-block">
                        <p class="primary-header__info-text fs-sm fw-medium mb-0">Welcome to our Organic store</p>
                    </div>
                </div>
                    ...
                    <ul
                        ...
                        <li class="nav-item">
                            <a href="mailto:groshop@support.com"
                                class="d-inline-flex align-items-center gap-1 primary-header__info-text">
                                <span class="me-1">
                                ...
                                <span class="d-inline-block fw-medium"> groshop@support.com </span>
                            </a>
                        </li>
                        <li class="nav-item primary-header__info-text d-inline-flex align-items-center gap-1">
                            <span class="me-1 primary-header__info-text">
                            ...
                            <span class="d-inline-block fw-medium"> Washington, New York, USA - 254230 </span>
                        </li>
                        <li class="nav-item dropdown tt-language-dropdown">
                            <a href="#" class="dropdown-toggle primary-header__info-text fw-medium"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                <img src="{{ asset('backend/assets/images/flags/usd.svg') }}" alt="country" class="img-fluid me-1" />
                                English
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                                ...
                                <li>
                                    <a class="dropdown-item" href="#">
                                        <img src="{{ asset('backend/assets/images/flags/bdt.svg') }}" alt="country" class="img-fluid me-1" />
                                        Bangla
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="#">
                                        <img src="{{ asset('backend/assets/images/flags/inr.svg') }}" alt="country" class="img-fluid me-1" />
                                        Hindi
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item dropdown tt-curency-dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item fs-xs" href="#"> $ USD </a>
                                </li>
                                <li>
                                    <a class="dropdown-item fs-xs" href="#"> ৳ BDT </a>
                                </li>
                                <li>
                                    <a class="dropdown-item fs-xs" href="#"> ₹ INR </a>
                                </li>
                                <li>
                                    <a class="dropdown-item fs-xs" href="#"> € EUR </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="javascript:void(0)" class="btn btn-link p-0 tt-theme-toggle fw-normal">
                                <div class="tt-theme-light" data-bs-toggle="tooltip" data-bs-placement="left"
                                    data-bs-title="Dark">
                                    Dark <i class="fas fa-moon fs-lg ms-1"></i>
                                </div>
                                <div class="tt-theme-dark" data-bs-toggle="tooltip" data-bs-placement="left"
                                    data-bs-title="Light">
                                    Light <i class="fas fa-sun fs-lg ms-1"></i>
                                </div>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="gshop-navbar bg-white rounded ps-lg-5 position-relative">
            <div class="row align-items-center">
                <div class="col-xxl-2 col-xl-3 col-md-3 col-5">
                    <a href="index.html" class="logo"><img src="{{ asset('backend/assets/images/logo.png') }}" alt="logo" class="img-fluid" /></a>
                </div>
                    ...
                    <div class="gshop-navbar-right d-flex align-items-center justify-content-end position-relative">
                        <div class="category-dropdown position-relative d-none d-md-inline-block">
                            <a href="javascript:void(0)"
                                class="primary-header__category-title category-dropdown-btn fw-bold d-none d-sm-inline-block">Browse
                                Category<span class="ms-1"><i class="fa-solid fa-angle-down"></i></span></a>
                            ...
                            <div class="category-dropdown-box scrollbar">
                                <ul class="category-dropdown-menu">
                                    <li>
                                        <a href="shop-grid.html" class="d-flex align-items-center">
                                            <div class="me-2 avatar-icon">
                                                <img src="{{ asset('backend/assets/images/category/fresh-fruits.png') }}" alt="vegetables"
                                    ...
                                    <li>
                                        <a href="shop-grid.html" class="d-flex align-items-center">
                                            <div class="me-2 avatar-icon">
                                                <img src="{{ asset('backend/assets/images/category/honey.png') }}" alt="vegetables"
                                                    class="w-100 h-100 rounded-circle" />
                                            </div>
                                            <span>Honey</span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="shop-grid.html" class="d-flex align-items-center">
                                            <div class="me-2 avatar-icon">
                                                <img src="{{ asset('backend/assets/images/category/fresh-organic.png') }}" alt="vegetables"
                                                    class="w-100 h-100 rounded-circle" />
                                            </div>
                                    ...
                                    <li>
                                        <a href="shop-grid.html" class="d-flex align-items-center">
                                            <div class="me-2 avatar-icon">
                                                <img src="{{ asset('backend/assets/images/category/jam-jelly.png') }}" alt="vegetables"
                                                    class="w-100 h-100 rounded-circle" />
                                            </div>
                                            <span>Jam & Jelly</span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="shop-grid.html" class="d-flex align-items-center">
                                            <div class="me-2 avatar-icon">
                                                <img src="{{ asset('backend/assets/images/category/sports-fitness.png') }}" alt="vegetables"
                                                    class="w-100 h-100 rounded-circle" />
                                            </div>
                                    ...
                                    <li>
                                        <a href="shop-grid.html" class="d-flex align-items-center">
                                            <div class="me-2 avatar-icon">
                                                <img src="{{ asset('backend/assets/images/category/sea-fish.png') }}" alt="vegetables"
                                                    class="w-100 h-100 rounded-circle" />
                                            </div>
                                            <span>Sea Fish</span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="shop-grid.html" class="d-flex align-items-center">
                                            <div class="me-2 avatar-icon">
                                                <img src="{{ asset('backend/assets/images/category/pet-care.png') }}" alt="vegetables"
                                                    class="w-100 h-100 rounded-circle" />
                                            </div>
                                            <span>Pet Care</span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="shop-grid.html" class="d-flex align-items-center">
                                            <div class="me-2 avatar-icon">
                                                <img src="{{ asset('backend/assets/images/category/meat.png') }}" alt="vegetables"
                                                    class="w-100 h-100 rounded-circle" />
                                            </div>
                                            <span>Meat</span>
                                        </a>
                        ...
                        <div
                            ...
                            <div class="gshop-header-user position-relative">
                                ...
                                <div class="user-menu-wrapper">
                                    <ul class="user-menu">
                                        <li>
                                            <a href="my-account.html"><span class="me-2"><i
                                                        class="fa-solid fa-user"></i></span>My Account</a>
                                        </li>
                                        <li>
                                            <a href="cart.html"><span class="me-2"><i
                                                        class="fa-solid fa-tags"></i></span>My Cart</a>
                                        </li>
                                        <li>
                                            <a href="wishlist.html"><span class="me-2"><i
                                                        class="fa-solid fa-heart"></i></span>My
                                                Wishlist</a>
                                        </li>
                                        <li>
                                ...
                                <div class="cart-box-wrapper">
                                    <div class="apt_cart_box theme-scrollbar">
                                        <ul class="at_scrollbar scrollbar">
                                            <li class="d-flex align-items-center">
                                                <div class="thumb-wrapper">
                                                    <a href="#"><img src="{{ asset('backend/assets/images/products/thumb-sm-1.png') }}"
                                            ...
                                            <li class="d-flex align-items-center">
                                                <div class="thumb-wrapper">
                                                    <a href="#"><img src="{{ asset('backend/assets/images/products/thumb-sm-2.png') }}"
                                                            alt="products" class="img-fluid" /></a>
                                                </div>
                                                <div class="items-content ms-3">
                                                    <a href="product-details.html">
                                            ...
                                            <li class="d-flex align-items-center">
                                                <div class="thumb-wrapper">
                                                    <a href="#"><img src="{{ asset('backend/assets/images/products/thumb-sm-3.png') }}"
                                                            alt="products" class="img-fluid" /></a>
                                                </div>
                                                <div class="items-content ms-3">
                                                    <a href="product-details.html">
                                            ...
                                            <li class="d-flex align-items-center">
                                                <div class="thumb-wrapper">
                                                    <a href="#"><img src="{{ asset('backend/assets/images/products/thumb-sm-4.png') }}"
                                                            alt="products" class="img-fluid" /></a>
                                                </div>
                                                <div class="items-content ms-3">
                                                    <a href="product-details.html">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-3">
                                            ...
                                            <span
                                                class="fw-semibold text-primary primary-header__subtotal">$1,247.00</span>
                                        </div>
                                        <a href="checkout.html"
                                            class="primary-header__checkout-btn btn btn-primary btn-md d-block mt-4"><span
                        ...
                        <div class="gshop-header-contact ms-7 position-relative d-none d-lg-flex d-xl-none d-xxl-flex">
                            <a href="tel:+801570584567" class="d-flex align-items-center">
                                <span
                                    class="primary-header__phn-icon icon d-inline-flex rounded-circle justify-content-center align-items-center">
                        ...
                        <button class="gshop-offcanvas-btn offcanvas-toggle ms-3 primary-header__menu-toggler">
