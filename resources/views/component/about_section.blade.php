        ...
        <section class="pt-120 ab-about-section position-relative z-1 overflow-hidden">
            <img src=" {{ asset('backend/assets/images/shapes/mango.png') }}" alt="mango" class="position-absolute mango z--1">
            <div class="container">
                <div class="row g-5 g-xl-4 align-items-center">
                    <div class="col-xl-6">
                        <div class="ab-left position-relative">
                            <img src=" {{ asset('backend/assets/images/about/ab-1.png') }}" alt="image" class="img-fluid">
                            <div class="text-end">
