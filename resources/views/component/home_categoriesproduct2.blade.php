<!--offer section start-->
<section class="offer-section hm3-offer-section mb--80" data-background="assets/img/home-3/bg-1.jpg">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-5">
                <div class="gshop-title text-center">
                    <h2 class="mb-3 text-white">Best Deals <mark
                            class="text-secondary position-relative z-1 p-0 bg-transparent">This Week<img
                                src="assets/img/shapes/line-shape.png" class="position-absolute border-line w-100"
                                alt="line shape"></mark></h2>
                    <p class="mb-0 text-white">Compellingly fashion intermandated opportunities and multimedia based
                        fnsparent e-business.</p>
                </div>
                <ul class="countdown-timer offer-countdown list-inline text-center mt-5"
                    data-date="06/30/2023 23:59:59">
                    <li class="gs-offer-countdown-box text-center list-inline-item">
                        <div class="bg-sky-captain py-2 px-3">
                            <h3 class="mb-0 text-white days">45</h3>
                            <h6 class="mb-0 gshop-subtitle text-white fw-normal">Days</h6>
                        </div>
                    </li>
                    <li class="gs-offer-countdown-box text-center list-inline-item">
                        <div class="bg-sky-captain py-2 px-3">
                            <h3 class="mb-0 text-white hours">45</h3>
                            <h6 class="mb-0 gshop-subtitle text-white fw-normal">Days</h6>
                        </div>
                    </li>
                    <li class="gs-offer-countdown-box text-center list-inline-item">
                        <div class="bg-sky-captain py-2 px-3">
                            <h3 class="mb-0 text-white minutes">45</h3>
                            <h6 class="mb-0 gshop-subtitle text-white fw-normal">Days</h6>
                        </div>
                    </li>
                    <li class="gs-offer-countdown-box text-center list-inline-item">
                        <div class="bg-sky-captain py-2 px-3">
                            <h3 class="mb-0 text-white seconds">45</h3>
                            <h6 class="mb-0 gshop-subtitle text-white fw-normal">Days</h6>
                        </div>
                    </li>
                </ul>
            ...
            <div class="offer-product-slider swiper pb-6">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="vertical-product-card rounded-2 position-relative border-0 bg-white">
                            ...
                            <div class="card-content text-center">
                                <a href="product-details.html" class="card-title fw-bold d-block mb-2">Dried Onion Kinh
                                    Men</a>
                                ...
                                <div
                                    class="d-flex align-items-center justify-content-center flex-nowrap star-rating fs-xxs mb-2">
                                ...
                                <a href="product-details.html"
                                    class="btn btn-outline-secondary border-secondary btn-md rounded-1 mt-4">Shop
                                    Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="vertical-product-card rounded-2 position-relative border-0 bg-white">
                            <div class="thumbnail position-relative text-center p-4">
                                <a href="#"><img src="assets/img/products/banana.png" alt="apple" class="img-fluid"></a>
                                <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                    <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                    <a href="#" class="rounded-btn">
                                        <svg width="14" height="11" viewBox="0 0 14 11" fill="none"
                    ...
                    <div class="swiper-slide">
                        <div class="vertical-product-card rounded-2 position-relative border-0 bg-white">
                            <span
                                ...
                                OFF</span>
                            <div class="thumbnail position-relative text-center p-4">
                                <a href="#"><img src="assets/img/products/stroberry.png" alt="apple"
                                        class="img-fluid"></a>
                                <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                    <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                    <a href="#" class="rounded-btn">
                    ...
                    <div class="swiper-slide">
                        <div class="vertical-product-card rounded-2 position-relative border-0 bg-white">
                            <div class="thumbnail position-relative text-center p-4">
                                <a href="#"><img src="assets/img/products/lemon.png" alt="apple" class="img-fluid"></a>
                                <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                    <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                    <a href="#" class="rounded-btn">
                                        <svg width="14" height="11" viewBox="0 0 14 11" fill="none"
