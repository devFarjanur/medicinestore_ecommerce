                ...
                <div class="gshop-sidebar bg-white rounded-2 overflow-hidden">
                    ...
                    <div class="sidebar-widget category-widget bg-white py-5 px-4 border-top">
                        ...
                        <ul class="widget-nav mt-4">
                            <li><a href="#" class="d-flex justify-content-between align-items-center">Apples<span
                                        class="fw-bold fs-xs total-count">08</span></a></li>
                            <li><a href="#" class="d-flex justify-content-between align-items-center">Organic
                                    Vegetable<span class="fw-bold fs-xs total-count">09</span></a></li>
                            <li><a href="#" class="d-flex justify-content-between align-items-center">Avocados<span
                                        class="fw-bold fs-xs total-count">06</span></a></li>
                            <li><a href="#" class="d-flex justify-content-between align-items-center">Dried Fruits &
                                    Nuts<span class="fw-bold fs-xs total-count">10</span></a></li>
                            <li><a href="#" class="d-flex justify-content-between align-items-center">Coffee<span
                                        class="fw-bold fs-xs total-count">11</span></a></li>
                            <li><a href="#" class="d-flex justify-content-between align-items-center">Juice Drinks<span
                                        class="fw-bold fs-xs total-count">15</span></a></li>
                            <li><a href="#" class="d-flex justify-content-between align-items-center">Fresh Fish<span
                                        class="fw-bold fs-xs total-count">18</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="vertical-product-card rounded-2 position-relative border-0 bg-white bg-white">
                                ...
                                <div class="card-content">
                                    ...
                                    <a href="#" class="card-title fw-bold d-block mb-2 tt-line-clamp tt-clamp-2">Popped
                                        Rice Crisps
                                        Snacks</a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="vertical-product-card rounded-2 position-relative border-0 bg-white bg-white">
                                <span
                                    ...
                                    OFF</span>
                                <div class="thumbnail position-relative text-center p-4">
                                    <img src="assets/img/products/beef.png" alt="apple" class="img-fluid">
                                    <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                        <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                        <a href="#" class="rounded-btn">
                                            <svg width="14" height="11" viewBox="0 0 14 11" fill="none"
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="vertical-product-card rounded-2 position-relative border-0 bg-white bg-white">
                                <span
                                    ...
                                    OFF</span>
                                <div class="thumbnail position-relative text-center p-4">
                                    <img src="assets/img/products/tomato-slice.png" alt="apple" class="img-fluid">
                                    <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                        <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                        <a href="#" class="rounded-btn">
                                            <svg width="14" height="11" viewBox="0 0 14 11" fill="none"
