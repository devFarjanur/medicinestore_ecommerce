        ...
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6">
                <div class="gshop_subscribe_form text-center">
                    <h4 class="text-white gshop-title">Subscribe to the G-Shop <mark
                            class="p-0 position-relative text-secondary bg-transparent">New Arrivals <img
                                src=" {{ asset('backend/assets/images/shapes/border-line.svg') }}" alt="border line"
                                class="position-absolute border-line"></mark><br class="d-none d-sm-block">& Other
                        Information.</h4>
                ...
                <div class="col-lg-4 d-none d-lg-block">
                    <div class="logo-wrapper text-center">
                        <a href="index.html" class="logo"><img
                                src=" {{ asset('backend/assets/images/logo-white.png') }}" alt="logo"
                                class="img-fluid"></a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="footer-payments-info d-flex align-items-center justify-content-lg-end gap-2">
                        <div
                            ...
                            <img src=" {{ asset('backend/assets/images/brands/visa.png') }}" alt="visa"
                                class="img-fluid">
                        </div>
                        <div
                            class="supported-payment-box rounded-1 bg-dark-light d-inline-flex align-items-center justify-content-center p-2 flex-shrink-0">
                            <img src=" {{ asset('backend/assets/images/brands/mastercard.png') }}" alt="visa"
                                class="img-fluid">
                        </div>
                        <div
                            class="supported-payment-box rounded-1 bg-dark-light d-inline-flex align-items-center justify-content-center p-2 flex-shrink-0">
                            <img src=" {{ asset('backend/assets/images/brands/payoneer.png') }}" alt="visa"
                                class="img-fluid">
                        </div>
                        <div
                            class="supported-payment-box rounded-1 bg-dark-light d-inline-flex align-items-center justify-content-center p-2 flex-shrink-0">
                            <img src=" {{ asset('backend/assets/images/brands/paypal.png') }}" alt="visa"
                                class="img-fluid">
                        </div>
                    </div>
                </div>
...
<div class="offcanvas-left-menu position-fixed">
    <div class="mobile-menu">
        ...
        <a href="#" class="d-inline-block mb-5"><img src="{{ asset('backend/assets/images/logo.png')}}" alt="logo"></a>
        <nav class="mobile-menu-wrapper scrollbar">
            <ul>
                <li>
                    <a href="shop-grid.html" class="d-flex align-items-center">
                        <div class="me-2 avatar-icon">
                            <img src="{{ asset('backend/assets/images/category/baby-care.png')}}" alt="vegetables"
                ...
                <li>
                    <a href="shop-grid.html" class="d-flex align-items-center">
                        <div class="me-2 avatar-icon">
                            <img src="{{ asset('backend/assets/images/category/cleaning.png')}}" alt="vegetables"
                                class="w-100 h-100 rounded-circle">
                        </div>
                        <span>Cleaning</span>
                    </a>
                ...
                <li>
                    <a href="shop-grid.html" class="d-flex align-items-center">
                        <div class="me-2 avatar-icon">
                            <img src="{{ asset('backend/assets/images/category/bakery-biscuits.png')}}" alt="vegetables"
                                class="w-100 h-100 rounded-circle">
                        </div>
                ...
                <li>
                    <a href="shop-grid.html" class="d-flex align-items-center">
                        <div class="me-2 avatar-icon">
                            <img src="{{ asset('backend/assets/images/category/coffee-drinks.png')}}" alt="vegetables"
                                class="w-100 h-100 rounded-circle">
                        </div>
                ...
                <li>
                    <a href="shop-grid.html" class="d-flex align-items-center">
                        <div class="me-2 avatar-icon">
                            <img src="{{ asset('backend/assets/images/category/beauty-health.png')}}" alt="vegetables"
                                class="w-100 h-100 rounded-circle">
                        </div>
                ...
                <li>
                    <a href="shop-grid.html" class="d-flex align-items-center">
                        <div class="me-2 avatar-icon">
                            <img src="{{ asset('backend/assets/images/category/breakfast.png')}}" alt="vegetables"
                                class="w-100 h-100 rounded-circle">
                        </div>
                        <span>Breakfast</span>
                    </a>
                ...
                <li>
                    <a href="shop-grid.html" class="d-flex align-items-center">
                        <div class="me-2 avatar-icon">
                            <img src="{{ asset('backend/assets/images/category/cold-drinks.png')}}" alt="vegetables"
                                class="w-100 h-100 rounded-circle">
                        </div>
