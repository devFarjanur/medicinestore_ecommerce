            ...
            <div class="row align-items-center">
                <div class="col-xxl-4 col-xl-3">
                    <div class="topbar-info d-none d-xl-block">
                        <p class="text-white fs-sm fw-medium mb-0">Welcome to our Organic Food store</p>
                    </div>
                </div>
                <div class="col-xxl-8 col-xl-9">
                    <ul
                        ...
                        <li class="nav-item">
                            ...
                            Kallyanpur, Dhaka, Bangladesh - 2542
                        </li>
                        <li class="nav-item">
                            <a href="#" aria-haspopup="true" aria-expanded="true">
                                <img src="{{ asset('backend/assets/images/flags/bdt.svg') }}" alt="country"
                                    class="img-fluid me-1">
                                English
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" aria-haspopup="true" aria-expanded="false">৳ BDT</a>
                        </li>
                    </ul>
                </div>
            </div>
                                            ...
                                            <a href="#" class="d-flex align-items-center">
                                                <div class="me-2 avatar-icon">
                                                    <img src="{{ asset('upload/admin_images/' . $category->photo) }}"
                                                        alt="Category Image" class="w-100 h-100 rounded-circle">
                                                </div>
                        ...
                        <nav class="gshop-navmenu ms-3 d-none d-xl-block">
                            <ul class="d-flex align-itmes-center justify-content-end">
                                <li class="has-submenu">
                                    <a href="{{ route('customer.index') }}">Home<span
                                            class="ms-1 fs-xs float-end"></span></a>

                                </li>
                                <li class="has-submenu">
                                    <a href="{{ route('customer.product') }}">Products<span
                                            class="ms-1 fs-xs float-end"></span></a>

                                </li>

                                <li class="has-submenu">
                                    <a href="{{ route('customer.about') }}">About Us<span
                                            class="ms-1 fs-xs float-end"></span></a>
                        ...
                        <div
                            ...
                            <div class="gshop-header-user position-relative">
                                ...
                                <div class="user-menu-wrapper">
                                    @auth
                                        <ul class="user-menu">
                                            <li><a href="{{ route('customer.myaccount') }}"><span class="me-2"><i
                                                            class="fa-solid fa-user"></i></span>My Account</a></li>
                                            <li><a href="{{ route('customer.cart') }}"><span class="me-2"><i
                                    ...
                                    @else
                                        <ul class="user-menu">
                                            <li><a href="{{ route('login') }}"><span class="me-2"><i
                                                            class="fa-solid fa-sign-in-alt"></i></span>Login</a></li>
                            ...
                            <div class="gshop-header-cart position-relative">
                                <a href="{{ route('customer.cart') }}">
                                    <button type="button" class="header-icon">
                                        ...
                                        <!-- Placeholder for total cart items in header -->
                                        <span id="total-items" class="rounded-badge">0</span>
                                    </button>
                                </a>
                            </div>
...
<div class="offcanvas_menu position-fixed">
    <div class="tt-short-info d-none d-md-none d-lg-none d-xl-block">
        ...
        <a href="#" class="logo-wrapper d-inline-block mb-5"><img src="backend/assets/images/logo.png" alt="logo" /></a>
        ...
        <div class="offcanvas-contact mt-5">
            ...
            <address>
                Kallyanpur, Dhaka, Bangladesh <br />
                <a href="#">+8801682648101</a> <br />
