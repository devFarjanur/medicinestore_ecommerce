...
<head>
    ...
    <!-- Title -->
    <title>GroStore Home - 2 - Grostore Grocery eCommerce HTML Template</title>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-12 tt-login-img"
                        data-background="{{ asset('backend/assets/images/banner/login-banner.jpg') }}">
                    </div>
                    <div class="col-lg-5 col-12 bg-white d-flex p-0 tt-login-col shadow">
                        <form class="tt-login-form-wrap p-3 p-md-6 p-lg-6 py-7 w-100" method="POST"
                            ...
                            <h2 class="mb-4 h3">Hey there! <br>Welcome back <span class="text-secondary">Organic Food
                                    Store</span></h2>
                            <div class="row g-3">
                                <div class="col-sm-12">
                            ...
                            <div class="row g-4 mt-4">
                                ...
                                <div class="col-sm-6">
                                    <a href="#" class="btn btn-outline google-btn w-100">
                                        <img src="{{ asset('backend/assets/images/brands/google.png') }}" alt="google"
                                            class="me-2">Sign with Google
                                    </a>
                                </div>
                            </div>
